...
class gui_pdf_load(gui_interface):
    ...
    def pdf_export(self,pdf_location = [], export = 'output'):
        ...
        for pdf in pdf_location:
            ...
            print("\n\nPDF location: ",pdf)
            print("Annotation location: ",anotacao_path)
            ...
            if len(anotacoes[pdf]) > 0:
                ...
                anotacao_reordenada = utils.annots_reorder_columns(annotations=anotacoes[pdf],columns=1,tolerance=0.1)
